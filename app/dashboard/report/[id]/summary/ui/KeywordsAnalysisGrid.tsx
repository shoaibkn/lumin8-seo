                    ...
                    <div className="flex items-start gap-3 sm:gap-4">
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-2 sm:gap-3 mb-3">
                          <h4 className="font-bold text-base sm:text-lg leading-tight wrap-break-word">
                            {keyword.keyword}
                          </h4>
                          <Badge
                        ...
                        {keyword.evidence && keyword.evidence.length > 0 && (
                          <div className="space-y-3 max-h-40 overflow-y-auto">
                            ...
                            {keyword.evidence.map((evidence, evidenceIndex) => (
                              ...
                              >
                                <p className="text-sm text-muted-foreground mb-3 italic leading-relaxed wrap-break-word">
                        ...
                        <div className="flex flex-wrap gap-1.5 sm:gap-2">
                          {theme.keywords.map((kw, kwIndex) => (
                            <Badge
                              key={kwIndex}
                              variant="secondary"
                              className="text-xs bg-white/60 dark:bg-black/20 text-orange-700 dark:text-orange-300 wrap-break-word max-w-full"
                            >
                              {kw}
                            </Badge>
                          ))}

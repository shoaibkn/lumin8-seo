...
export default function AIChat({ seoReportId }: { seoReportId: string }) {
  ...
  return (
    <>
      {/* Chat Widget */}
      {isExpanded && (
        <div className="fixed bottom-20 right-6 z-50 w-[500px] h-[600px] bg-card rounded-3xl shadow-2xl border border-primary flex flex-col overflow-hidden">
          {/* Header */}
          ...
          <div ref={chatRef} className="flex-1 overflow-y-auto p-6 space-y-4">
            {messages.length === 0 && (
              <div className="text-center text-primary text-sm py-8">
          ...
          {/* Input */}
          <div className="p-5 border-t border-gray-100 bg-primary/50">
            <form onSubmit={handleSubmit} className="flex gap-3">
              ...
              <Button
                ...
                className="h-11 w-11 text-primary-foreground px-4 bg-primary rounded-full shadow-sm"
              >

...
const Greeter = () => {
  ...
  if (isMobile) {
    return (
      ...
      <Drawer open={true}>
        <DrawerContent className="flex-col items-center justify-center p-0 z-50 rounded-xl max-w-3xl">
          <div className="bg-background rounded-xl overflow-auto">
            <div className="flex flex-col lg:flex-row">
              {/* Top side - Changelog with colored background */}
              ...
              <div className="bg-linear-to-br from-primary to-secondary p-8 text-white h-fit">
                ...
                <Button
                  ...
                  className="mt-12 w-full h-12 bg-linear-to-r font-semibold py-3 px-4 rounded-lg transition-colors"
                >
                  Get Started
                </Button>
              </div>
      ...
      <CardContent className="flex items-center justify-center p-0 z-50 rounded-xl max-w-3xl">
        <div className="bg-background rounded-xl shadow-2xl overflow-hidden">
          <div className="grid grid-cols-2 lg:flex-row">
            ...
            <div className="col-span-1 bg-linear-to-br from-primary to-secondary p-8 text-white">
              <div className="flex items-center gap-2 mb-6">
                <Sparkles className="w-5 h-5" />
                <h2 className="text-2xl font-bold">What&apos;s New</h2>
              </div>
            ...
            <div className="col-span-1 p-8 flex flex-col justify-between">
              ...
              <Button
                variant="default"
                onClick={() => setShowDialog(false)}
                className="w-full h-12 font-semibold py-3 px-4 rounded-lg transition-colors"
              >
                Get Started
              </Button>
            </div>
